from models.dgcnn import DGCNNBinaryClass
...
class SorghumPartNetLeaf(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        tensorboard_logs = {"train_leaf_loss": leaf_loss, "train_leaf_acc": acc}
    ...
    def validation_step(self, batch, batch_idx):
        ...
        tensorboard_logs = {"val_leaf_loss": leaf_loss, "val_leaf_acc": acc}
